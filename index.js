...
console.log(`The user prefers ${flavorSelection} Monster Energy drink.`);
...
let currentHour = 22; 
let currentDecision = (currentHour >= 7 && currentHour < 24) ? "Unleash the beast!": "Better stick to water.";
...
// Console log results should appear in a list

// Get the element with the ID 'consoleResult'
let consoleResultElement = document.getElementById('consoleResult');

// Create an unordered list element
let ul = document.createElement('ul');

// Create a list item for the console result
let listItem1 = document.createElement('li');
listItem1.textContent = `The user prefers ${flavorSelection} Monster Energy drink.`;

let listItem2 = document.createElement('li');
listItem2.textContent += stockCheck;

let listItem3 = document.createElement('li');
listItem3.textContent += workoutIntensity;

let listItem4 = document.createElement('li');
listItem4.textContent += tempSuitability;

let listItem5 = document.createElement('li');
listItem5.textContent += currentDecision;
...
// Append the unordered list to the 'consoleResult' element
consoleResultElement.appendChild(ul);